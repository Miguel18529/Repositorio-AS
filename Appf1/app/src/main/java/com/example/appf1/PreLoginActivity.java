    ...
    public void accesoBD(Map<String, Map<String, String>> valores){
        ...
        if(db!= null){
            ...
            for(int i = 0; i<valores.size(); i++){
                ...
                query = query + String.valueOf(getResources().getIdentifier(keys.get(i).split(" ")[1].substring(0, 3).toLowerCase(Locale.ROOT) + "number", "drawable", getPackageName())) + String.valueOf(',');
                query = query + String.valueOf(getResources().getIdentifier(keys.get(i).split(" ")[1].substring(0, 3).toLowerCase(Locale.ROOT) + "2", "drawable", getPackageName())) + String.valueOf(',');
                query = query + String.valueOf(getResources().getIdentifier(keys.get(i).split(" ")[1].substring(0, 3).toLowerCase(Locale.ROOT) + "helmet", "drawable", getPackageName())) + String.valueOf(',');
